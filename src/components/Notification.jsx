    ...
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          ...
          <button type="button" className="font-semibold text-xs dark:text-gray-200 "> 5 New</button>
        </div>
        <Button icon={<MdOutlineCancel />} color="rgb(0, 171, 180)" bgHoverColor="light-gray" size="2xl" borderRadius="50%" />
      </div>
      <div className="mt-5 ">
